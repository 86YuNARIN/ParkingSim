...
public class CarNavMesh : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject mainRoadInstance = GameObject.Find("Main Road"); // Change "MainRoad" to the actual name of your instance
